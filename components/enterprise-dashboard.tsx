              ...
              <Card key={applicant.id} className="p-4 hover:shadow-md transition-shadow">
                ...
                <div className="flex gap-2 mt-4">
                  {applicant.status === "pending" && (
                    <>
                      <Button className="flex-1 bg-green-600 hover:bg-green-700 text-white text-sm">Aprobar</Button>
                      <Button className="flex-1 bg-red-600 hover:bg-red-700 text-white text-sm">Rechazar</Button>
                    </>
                  )}
